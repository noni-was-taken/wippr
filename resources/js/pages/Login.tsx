            ...
            <div className="bg-black h-screen w-screen flex items-center ">
                <div className={ `bg-white h-full flex flex-col items-center justify-center transition-all duration-300
                    ...
                    <div className={`w-4/5 h-1/2 flex flex-col justify-center items-center gap-5 
                        ...
                        <img src="/logos/colored.png" alt="logo" className='h-1/2 w-auto  object-cover'/>
                ...
                <div className={`bg-amber-600 h-full flex flex-col items-center justify-center transition-all duration-300
                                ${signUp ? 'w-1/3' : 'w-2/3'}
                `}>
                    <LoginForm signUp={signUp}/>
                    <div className={`w-4/5 h-1/2 flex flex-col justify-center items-center gap-5 
                        ${signUp ? 'opacity-100 scale-100 max-h-96' : 'opacity-0 scale-0 max-h-0' } transition-all duration-500`}>
                        <img src="/logos/white.png" alt="logo" className='h-1/2 w-auto  object-cover'/>
